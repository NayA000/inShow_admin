...
public class Users implements Serializable {
	...
	public String toString() {
		return "Users [id=" + id + ", openid=" + openid + ", username=" + username + ", gender=" + gender
				+ ", avatarurl=" + avatarurl + ", country=" + country + ", province=" + province + ", city=" + city
				+ ", nickname=" + nickname + ", fansCounts=" + fansCounts + ", followCounts=" + followCounts
				+ ", receiveLikeCounts=" + receiveLikeCounts + ", reportCounts=" + reportCounts + "]";
	}
